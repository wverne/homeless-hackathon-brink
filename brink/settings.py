"""
Django settings for brink project.
...
try:
    ...
    try:
        ...
        raise RuntimeError("Secret key could not be created at "
                           "/etc/opt/steamaco/lora-fog/secret_key.txt")
...
WSGI_APPLICATION = 'brink.wsgi.application'
